                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="border rounded p-3 bg-light h-100">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-4">
                                                    <label class="form-label">After Tax Amount</label>
                                                    <input type="text" class="form-control @error('sale_after_tax') is-invalid  @enderror" name="sale_after_tax" placeholder="After Tax Amount" readonly>
                                                    @error('sale_after_tax')
                                                        <span class="text-danger" style="font-size: 13px;">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <div class="mb-3 col-4">
                                                ...
                                                <div class="mb-3 col-4">
                                                    ...
                                                    <input type="text" class="form-control @error('sale_wht_amount') is-invalid  @enderror" name="sale_wht_amount" placeholder="WHT Amount" readonly>
                                                    @error('sale_wht_amount')
                                                        <span class="text-danger" style="font-size: 13px;">{{ $message }}</span>
                                                    @enderror
                                                </div>
...
function calculateSaleValues() {
    ...
    const whtPercent = parseFloat($('[name="sale_wht_percent"]').val()) || 0;
    ...
    // 5. Net Amount
    const netAmount = (
        parseFloat(afterTax) + parseFloat(whtAmount) - parseFloat(discountAmount)
    ).toFixed(2);

     // Update fields
    $('[name="sale_tax_amount"]').val(taxAmount);
    $('[name="sale_after_tax"]').val(afterTax);
...
// Bind inputs so values auto-update
