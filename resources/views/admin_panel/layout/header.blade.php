                    ...
                    <div class="nav_wrapper_main d-flex align-items-center justify-content-between flex-grow-1">
                        ...
                        *====================================-->
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right navbar-dropdown rt-notification-list" aria-labelledby="notificationDropdown">
                        ...
                        *====================================-->
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right navbar-dropdown rt-notification-list" aria-labelledby="messageDropdown">
                                    <div class="dropdown-item">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <ul>
                                                                ...
                                                                <li class="nav-item"><a class="nav-link" href="{{url('outstanding-losses')}}"><i class="menu_icon ti-alert"></i><span>Outstanding Losses</span></a></li>
                            ...
                            *===========================-->
                                    <div class="col-group col-md-4">
                                        ...
                                        {{-- @if(auth()->user()->can('View Product') || auth()->user()->email === 'admin@admin.com') --}}
                                            <li class="nav-item"><a class="nav-link" href="{{route('products.index')}}"><i class="menu_icon icon-basket"></i><span>Products</span></a></li>
                                        {{-- @endif --}}
